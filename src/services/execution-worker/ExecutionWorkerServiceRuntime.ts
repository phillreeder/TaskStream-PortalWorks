import type { ExecutionWorkerMicroservice } from './ExecutionWorkerMicroservice.js';

export interface ExecutionWorkerServiceRuntimeOptions {
  readonly service: ExecutionWorkerMicroservice;
...
export class ExecutionWorkerServiceRuntime {
  private readonly processRef: NodeJS.Process;
  private started = false;
  private stopping: Promise<void> | null = null;

  constructor(private readonly options: ExecutionWorkerServiceRuntimeOptions) {
