...
OUTPUT_ZIP="$(dirname "$0")/bundle.zip"
...
INCLUDE_PATHS=(
  ...
  "docs/System/Modules/**"
  "docs/System/Schemas/DB/Tables/Runs.md"
  "docs/System/Schemas/DB/Tables/Steps.md"
  "docs/System/Schemas/DB/Tables/Logs.md"
  "docs/System/Schemas/DB/Tables/Artifacts.md"
  "docs/System/Architecture/Relationships"
  "docs/System/Schemas/DB/Tables/Dataset.md"
  "",
)
